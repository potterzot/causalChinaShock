...
log using ../log/cbp1990_imputations.log, replace

use ../dta/CBP_1990.dta, clear
...
save cbp1990temp.dta, replace

use cbp1990temp.dta, clear
...
save ../dta/CBP_1990adj.dta, replace

erase cbp1990temp.dta
